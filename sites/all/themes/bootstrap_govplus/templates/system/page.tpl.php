...
<header id="navbar" class="main-header" role="banner" class="<?php print $navbar_classes; ?>">
  ...
  <a href="index2.html" class="logo">
          ...
          <span class="logo-mini">
              <img alt="<?php print t('WxT Logo'); ?>" src="/sites/all/themes/bootstrap_govplus/images/Flag_of_Canada.svg.png"  />
          </span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">
              <object id="header-logo" data='/sites/all/themes/bootstrap_govplus/images/sig-blk-en.svg' role="img" tabindex="-1" type="image/svg+xml">
                <img alt="<?php print t('WxT Logo'); ?>" src="/sites/all/themes/bootstrap_govplus/images/Wordmark_Bl_Rd_RGB.jpg"  />
              </object>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="/sites/default/files/lte/user2-160x160.jpg" class="img-circle" alt="User Image">
