                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <?php
                    ...
                    if ($user->uid) {
                      ...
                      print theme('image_style', array('attributes' => array('class' => array('user-image')) , 'path' => $account->field_user_picture['und'][0]['uri'], 'style_name' => 'medium'));
                      print '<span class="hidden-xs">' . $account->field_firstname['und'][0]['value'] . '</span>';
  ...
  <section class="sidebar" style="height: auto;">
      <div class="user-panel">
            <div class="pull-left image">
              <?php
              if ($user->uid) {
                $myuserid = user_load($user->uid);
                print theme('image_style', array('attributes' => array('class' => array('img-circle')) , 'path' => $myuserid->field_user_picture['und'][0]['uri'], 'style_name' => 'medium'));
              }
              ?>
            </div>
            <div class="pull-left info">
              <p>
                <?php
                  ...
                  if ($user->uid) {
                    $myuserid = user_load($user->uid);
                    print $myuserid->field_firstname['und'][0]['value'];
                  }
                ?>
              </p>
