...
?>
<?php
  $base = ($GLOBALS['language']->language == 'fr') ? 'evenements/' : 'events/';
  $event_link = l($day, $base . $date . '--' . $date);
?>
<div class="<?php print $granularity ?> <?php print $class; ?>"> <?php print !empty($selected) ? $event_link : $day; ?> </div>
